...
static inline void check_irq_param(unsigned int num) {
 ...
 */
void irq_set_priority(unsigned int num, uint8_t hardware_priority);
 ...
 */
unsigned int irq_get_priority(unsigned int num);
 ...
 */
bool irq_is_enabled(unsigned int num);
 ...
 */
irq_handler_t irq_get_exclusive_handler(unsigned int num);
 ...
 * \see irq_set_exclusive_handler()
 */
void irq_add_shared_handler(unsigned int num, irq_handler_t handler, uint8_t order_priority);
 ...
 * \see irq_add_shared_handler()
 */
void irq_remove_handler(unsigned int num, irq_handler_t handler);
 ...
 */
bool irq_has_shared_handler(unsigned int num);
 ...
 */
irq_handler_t irq_get_vtable_handler(unsigned int num);
 ...
 * \param num Interrupt number \ref interrupt_nums
 */
void irq_set_pending(unsigned int num);
 ...
 */
void user_irq_claim(unsigned int irq_num);
 ...
 */
void user_irq_unclaim(unsigned int irq_num);
 ...
 */
bool user_irq_is_claimed(unsigned int irq_num);
